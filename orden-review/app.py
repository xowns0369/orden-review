...
def result():
    ...
    KNOWHOW_DB = {
        "tips_duration": {
            ...
            "만성": "🔄 [만성 통증 관리] 주변 근육의 유착과 약화가 원인입니다. '온찜질'로 혈액순환을 돕고, 통증이 없는 범위 내에서 조금씩 가동 범위를 늘려나가는 것이 중요합니다."
        },
        "tips_job": {
            "사무직": "💻 [직장인 환경 개선] 거북목 자세와 굽은 등이 주범입니다. 모니터 높이를 눈높이로 올리고 50분마다 '기지개'를 켜는 습관을 만드세요.",
            "현장직": "👷 [부상 예방] 특정 근육의 과사용이 원인입니다. 작업 전후 '예열 및 정리 스트레칭'이 부상을 방지하는 유일한 길입니다.",
            "운동선수": "👟 오버트레이닝은 독이 됩니다. 통증이 느껴진다면 훈련 강도를 즉시 낮추고 보조 근육 강화 운동에 집중하세요.",
            "학생": "📖 [자세 개선] 공부할 때 고개를 너무 숙이지 마세요. 가슴을 펴는 것만으로도 목과 어깨의 하중이 절반으로 줄어듭니다. 독서대를 사용하고 엉덩이를 의자 깊숙이 넣어 앉으세요.",
            "주부/은퇴": "🏠 [생활 습관 개선] 손가락과 손목의 반복 사용이 많습니다. 무거운 냄비를 들 때 양손을 사용하고 틈날 때마다 손을 가볍게 털어주세요. 바닥에 앉거나 쪼그려 앉는 좌식 생활이 관절을 망칩니다. 반드시 소파, 의자, 침대를 사용하는 생활로 전환하세요."
        },
        "main_knowhow": {
            "목": {
                "10~20대": "스마트폰 사용 시 고개를 숙이지 말고 눈높이로 올리세요. 목 뒤 근육 이완이 성장에 도움을 줍니다.",
                "30~40대": "일자목이 디스크로 진행되는 시기입니다. 턱을 당기는 '치킨 턱' 운동으로 경추 곡선을 회복하세요.",
                "50~60대": "경추 협착을 주의해야 합니다. 갑작스럽게 목을 돌리는 동작을 피하고 늘 따뜻하게 유지하세요.",
                "70대 이상": "목 근육이 약해지면 어지럼증이 올 수 있습니다. 수면 시 베개 높이를 적절히 조절하여 목 부담을 줄이세요."
            },
            "허리": {
