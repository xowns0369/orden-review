...
hospitals =[
    ...
    {"name": "이보다구강악안면외과치과의원","category":"치과","gu":"검단구", "region": "원당동", "address": "인천 서구 바리미로 17 4층", "keywords": ["의식하진정법","임플란트","사랑니","턱관절","수술치료"], "rating": 0,"website": "http://www.evodaoms.co.kr/","commercial_level": 2},
...
# 서구 정형외과
    ...
    {"name": "더본마취통증의학과의원","category":"정형외과","gu":"서구", "region": "심곡동", "address": "인천 서구 서곶로 293 5층 502호", "keywords": ["주사치료","척추클리닉","도수치료"], "rating": 0,"website": "","commercial_level": 1},
