...
def index():
    ...
    # ✅ 첫 화면 여부 판단 → 검색 / 필터 / 정렬 있으면 notice 변경
    show_notice = False
    if search_query or gu or category or region or sort_option:
        show_notice = True
    ...
    return render_template(
        ...
        regions=regions,
        show_notice=show_notice  # ✅ 여기도 넣어줌
    )
